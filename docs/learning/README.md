...
| 009 | 클릭 이벤트 | 모바일 메뉴의 클래스와 열림 상태 변경 | [클릭 이벤트로 모바일 메뉴 열고 닫기](009-menu-click-event.md) |
| 010 | 부드러운 스크롤 | 앵커 이동 방식과 동작 줄이기 선호 적용·비교 | [CSS로 앵커 이동을 부드럽게 만들기](010-smooth-scrolling.md) |
